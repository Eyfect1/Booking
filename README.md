...
Одностраничное приложение для бронирования столика в ресторане с формой, валидацией, экраном подтверждения и адаптивной вёрсткой.

## Ссылки

|                  | URL                                   |
| ---------------- | ------------------------------------- |
| **Репозиторий**  | https://github.com/Eyfect1/Booking.git|
| **Live preview** | https://booking-five-silk.vercel.app/ |
